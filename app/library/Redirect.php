...
class Redirect
{
  ...
  {
    return $route->uri !== $_SESSION['redirect']['actual'] && $route->request === $_SESSION['redirect']['request'] || $route->uri === $_SESSION['redirect']['actual'] && $route->request !== $_SESSION['redirect']['request'];
  }
